...
/**
 * Attackable Kill event.
 * @author UnAfraid
 * @author Zoey76
 */
public record AttackableKill(L2PcInstance attacker, L2Attackable target, boolean isSummon) implements BaseEvent {
	@Override
	public EventType getType() {
		return ATTACKABLE_KILL;
	}
}
