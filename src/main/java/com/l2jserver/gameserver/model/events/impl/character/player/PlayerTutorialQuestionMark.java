...
/**
 * Player Tutorial Question Mark event.
 * @author Zealar
 * @author Zoey76
 * @since 2.6.0.0
 */
public record PlayerTutorialQuestionMark(L2PcInstance player, int number) implements BaseEvent {
	@Override
	public EventType getType() {
		return PLAYER_TUTORIAL_QUESTION_MARK;
	}
}
