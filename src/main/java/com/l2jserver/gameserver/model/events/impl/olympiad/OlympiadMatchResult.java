...
/**
 * Olympiad Match Result event.
 * @author UnAfraid
 * @author Zoey76
 */
public record OlympiadMatchResult(Participant winner, Participant loser, CompetitionType competitionType) implements BaseEvent {
	@Override
	public EventType getType() {
		return OLYMPIAD_MATCH_RESULT;
	}
}
