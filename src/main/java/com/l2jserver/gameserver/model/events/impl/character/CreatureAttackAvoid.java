...
/**
 * Creature Attack Avoid event.
 * @author Zealar
 * @author Zoey76
 */
public record CreatureAttackAvoid(L2Character attacker, L2Character target, boolean damageOverTime) implements BaseEvent {
	@Override
	public EventType getType() {
		return CREATURE_ATTACK_AVOID;
	}
}
