...
/**
 * Player Level Changed event.
 * @author UnAfraid
 * @author Zoey76
 */
public record PlayerLevelChanged(L2PcInstance player, int oldLevel, int newLevel) implements BaseEvent {
	@Override
	public EventType getType() {
		return PLAYER_LEVEL_CHANGED;
	}
}
