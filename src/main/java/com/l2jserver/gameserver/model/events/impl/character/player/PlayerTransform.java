...
import static com.l2jserver.gameserver.model.events.EventType.PLAYER_TRANSFORM;
 ...
 * @author UnAfraid
 */
public record PlayerTransform(L2PcInstance player, int transformId) implements BaseEvent {
	@Override
