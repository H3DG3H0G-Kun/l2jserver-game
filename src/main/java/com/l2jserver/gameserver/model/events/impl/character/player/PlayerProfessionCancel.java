...
/**
 * Player Profession Cancel event.
 * @author Krunchy
 * @author Zoey76
 * @since 2.6.0.0
 */
public record PlayerProfessionCancel(L2PcInstance player, int classId) implements BaseEvent {
	@Override
	public EventType getType() {
		return PLAYER_PROFESSION_CANCEL;
	}
}
