...
/**
 * Player Profession Change event.
 * @author UnAfraid
 * @author Zoey76
 */
public record PlayerProfessionChange(L2PcInstance player, L2PcTemplate template, boolean isSubClass) implements BaseEvent {
	@Override
	public EventType getType() {
		return PLAYER_PROFESSION_CHANGE;
	}
}
