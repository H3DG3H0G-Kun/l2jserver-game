...
/**
 * Player Quest Accepted event.
 * @author Charus
 * @version 2.6.3.0
 */
public record PlayerQuestAccepted(L2PcInstance player, L2Npc npc, int questId) implements BaseEvent {
	@Override
	public EventType getType() {
		return PLAYER_QUEST_ACCEPTED;
	}
}
