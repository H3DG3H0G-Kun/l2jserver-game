...
/**
 * Player Tutorial Client Event event.
 * @author Zealar
 * @author Zoey76
 * @since 2.6.0.0
 */
public record PlayerTutorialClientEvent(L2PcInstance player, int event) implements BaseEvent {
	@Override
	public EventType getType() {
		return PLAYER_TUTORIAL_CLIENT_EVENT;
	}
}
